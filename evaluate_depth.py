    ...
    if opt.ext_disp_to_eval is None:
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                inv_K = torch.autograd.Variable(data[("inv_K", 0)].cuda(non_blocking=True))
                ...
                output = depth_decoder(features, inv_K)

                pred_disp = 1/output[("depth", 0, 0)]
